$(document).ready(function(){
    //$("#kCalendar").click(function(e){
        //$(e.currentTarget).
        //alert(e.currentTarget).getElement
    //})
});

/* Kurien / Kurien's Blog/ + my jquery */
function kCalendar(id, date) {
    ...
    $(".mon,.tue,.wed,.thu,.fri,.sat,.sun").click(function(event){
        var day=$(event.currentTarget).text();
        if(!(1<=day && day<=31)){
            return;
        }
